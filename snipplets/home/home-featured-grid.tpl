...
{% set title_section = settings.sm_shop_title %}
{% set color_title_section = settings.sm_shop_color_title %}
...
<div class="container p-0 mb-neg-1">
    <div class="row no-gutters">
        {% if section_slider or section_title %}
            <div class="col-12 bottom-line mb-3{% if section_slider and not section_title %}-md{% endif %}">
                <div class="row no-gutters justify-content-between{% if use_slider %} mx-neg-1{% endif %}">
                    ...
                    {% if section_title %}
                        <div class="col">
                            <h2 class="h6 m-0 p-3 text-center" {% if color_title_section %} style="color: {{color_title_section}};" {% endif %}>{{ title_section }}</h2>
                        </div>
                    {% endif %}
                    {% if use_slider %}
                        <div class="col-auto d-none d-md-block">
