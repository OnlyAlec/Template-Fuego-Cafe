...
{% set show_help = not (has_main_slider or has_mobile_slider or has_video or has_main_categories or has_banners or has_promotional_banners or has_news_banners or has_brands or has_informative_banners or has_instafeed or has_testimonials or has_institutional_message or has_welcome_message) and not has_products %}
		...
		{% set section_select = attribute(settings,"#{section}") %}
			...
			{% if section_select not in newArray %}
				...
				{% set head_transparent_section = (has_main_slider or has_mobile_slider) and settings.head_transparent %}
					...
					<section data-store="home-slider" {% if head_transparent_section %} data-header-type="transparent-on-section" {% endif %} data-transition="fade-in"> {% include 'snipplets/home/home-slider.tpl' %}
			...
			{% elseif section_select == 'recetas' %}

				{#  **** Recetas ****  #}
				{% include 'snipplets/recetas/recetas.tpl' with {class_section: "section-recetas"} %}
