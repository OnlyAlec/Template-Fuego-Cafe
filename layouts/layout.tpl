    ...
    <head>
        ...
        <style>
			...
			@font-face {
				...
				src: url('static/css/fonts/VI Cam Thach Normal.ttf').format('truetype');
			}

			@font-face {
				font-family: "Hergon Grotesk";
				src: url('static/css/fonts/HergonGrotesk-Thin.otf').format('opentype');
			}
